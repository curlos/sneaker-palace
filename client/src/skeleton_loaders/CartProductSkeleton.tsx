...
const CartProductSkeleton = () => {
	return (
		<div role="status" className="flex animate-pulse w-full bg-transparent gap-2 mb-2">
			<div className="p-1 bg-gray-300 rounded-2xl h-[150px] w-[150px]"></div>

			<div className="rounded-2xl w-full h-[150px] flex flex-col gap-2">
