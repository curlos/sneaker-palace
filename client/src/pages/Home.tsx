  ...
  return (
    <div>
      <div className="bg-kobe-hof-shoes h-screen bg-cover flex items-center text-white font-bold">
        <div className="ml-10 pb-10 w-1/4">
          <div className="text-5xl mb-3">Nike Kobe 5 Protro Undefeated 'Hall of Fame'</div>
      ...
      <div className="px-24">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex-2">
            <img src="/assets/brand_logos/chanel.svg" className="w-full"/>
          </div>

          
        </div>

        <div className="mt-5 flex w-full mb-10">
          <div className="w-4/12">
            <img src="/assets/landing_page/mens.jpeg" alt="Mens Shoe" className="w-full"/>
            <Link to={``} className="underline font-medium text-xl">Shop Men</Link>
          </div>

          <div className="w-4/12">
            <img src="/assets/landing_page/womens.jpeg" alt="Mens Shoe" className="w-full"/>
            <Link to={``} className="underline font-medium text-xl">Shop Women</Link>
          </div>

          <div className="w-4/12">
            <img src="/assets/landing_page/kids.jpeg" alt="Mens Shoe" className="w-full"/>
            <Link to={``} className="underline font-medium text-xl">Shop Kids</Link>
          </div>
