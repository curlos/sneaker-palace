  ...
  return (
    <div className="text-xl-lg">
      <div className="bg-gray-200">
        <div className="container mx-auto px-4 py-2 max-w-7xl flex justify-center text-lg font-bold">FREE SHIPPING ON ALL SHOES</div>
      </div>
          ...
          {loading ?
            <div className="flex justify-center flex-wrap lg:justify-between py-4">
              ...
              <div>
                ...
                <Pagination pageLimit={Math.ceil(totalShoeCount / 12)} dataLimit={12} currentPage={currentPage} setCurrentPage={setCurrentPage} totalItemCount={totalShoeCount} />
              </div>
            )}
        </div>
