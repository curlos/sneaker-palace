...
const FOOTER_BRANDS = [
	...
	},
	{
		...
		shoes: [
			{
				id: '724a1c4b-30e3-4ac4-b289-bbb7e868c26e',
	...
	},
	{
		...
		shoes: [
			...
			{
				id: '29a49eea-196d-445c-9ed2-5395fd692c2e',
				name: "Lionel Messi x Samba 'Inter Miami CF - Debossed Away Kit'",
			},
		],
	},
	{
		...
		shoes: [
			{
				id: 'aa2ec912-f82b-44b5-b783-f0f5f90c0975',
				name: "Teddy Santis x 991v2 Made in England 'Celestial Blue'",
			},
			...
			{
				id: '4d9b03c6-9f64-4082-847d-cddcd03bb8b4',
				name: "Salehe Bembury x 1500 Made in England 'Growth Be The Tree'",
			},
		],
	},
	{
		...
		shoes: [
			...
			{
				id: '69a01845-dc17-4a0d-b133-ac0036880595',
				name: "Cecilie Bahnsen x Gel Kayano 20 'Vanilla Pure Silver'",
			},
		...
		<footer className="bg-black text-white text-xs max-sm:pt-2 pt-10 max-lg:text-lg">
			<div className="container mx-auto px-4 max-w-7xl flex justify-center py-5 border-0 border-b border-solid border-gray-400 max-lg:hidden">
				{FOOTER_BRANDS.map((brandData) => (
					<div
						key={brandData.brand}
						className="w-1/6 px-4 max-lg:w-full max-lg:flex max-lg:flex-col max-lg:mb-4"
					>
						<div>
							<Link
