...
const FOOTER_BRANDS = [
	{
		...
		shoes: [
			...
			{
				id: '02415a72-3055-45f4-9a7e-9f4c00516963',
				name: 'Nike Air Zoom Infinity Tour NRG US Open Torrey Pines Pack',
			},
	...
	},
	{
		...
		shoes: [
			...
			{
				id: '1e8a27dd-c915-40b3-9687-9ed41387aa9e',
				name: "Wmns UltraBoost 4.0 DNA Wide 'White Copper Metallic'",
			},
			{ id: '4ebbd816-f524-4f78-b838-5435f82fd02c', name: 'adidas Yeezy QNTM Onyx' },
			{
				id: '248500c2-4e79-4266-99d8-bde4b72d83e0',
				name: "Swarovski x Wmns UltraBoost Slip-On DNA 'Triple Black'",
			},
	...
	},
	{
		...
		shoes: [
			...
			{
				id: 'e08357fe-5f37-4f80-af5c-be61f3316861',
				name: "Wmns Fresh Foam X LAV v2 Wide 'Pink Glow Deep Violet'",
			},
		],
	},
	{
		...
		shoes: [
			...
			{
				id: 'fcf97b5f-78b9-4dbc-8d0a-c1dd790ec350',
