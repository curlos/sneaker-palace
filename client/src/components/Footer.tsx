    ...
    <div className="bg-black text-white text-xs pt-10 lg:text-lg">
      <div className="flex justify-center py-5 px-10 border-0 border-b border-solid border-gray-400 lg:block">
        ...
        <div className="w-1/6 px-4 lg:w-full lg:flex lg:flex-col lg:mb-4">
          <div><Link to="/shoe/c8e2e33f-4272-4e3b-8a2c-a4a650bc9c0d" className="text-sm lg:text-2xl">Nike</Link></div>
        ...
        <div className="w-1/6 px-4 lg:w-full lg:flex lg:flex-col lg:mb-4">
          <div><Link to="/shoe/c8e2e33f-4272-4e3b-8a2c-a4a650bc9c0d" className="text-sm lg:text-2xl">Air Jordan</Link></div>
        ...
        <div className="w-1/6 px-4 lg:w-full lg:flex lg:flex-col lg:mb-4">
          <div><Link to="/shoe/c8e2e33f-4272-4e3b-8a2c-a4a650bc9c0d" className="text-sm lg:text-2xl">Adidas</Link></div>
        ...
        <div className="w-1/6 px-4 lg:w-full lg:flex lg:flex-col lg:mb-4">
          <div><Link to="/shoe/c8e2e33f-4272-4e3b-8a2c-a4a650bc9c0d" className="text-sm lg:text-2xl">New Balance</Link></div>
        ...
        <div className="w-1/6 px-4 lg:w-full lg:flex lg:flex-col lg:mb-4">
          <div><Link to="/shoe/c8e2e33f-4272-4e3b-8a2c-a4a650bc9c0d" className="text-sm lg:text-2xl">Louis Vuitton</Link></div>
        ...
        <div className="w-1/6 px-4 lg:w-full lg:flex lg:flex-col lg:mb-4">
          <div><Link to="/shoe/c8e2e33f-4272-4e3b-8a2c-a4a650bc9c0d" className="text-sm lg:text-2xl">Gucci</Link></div>
